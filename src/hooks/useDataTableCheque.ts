...
export const useDataTableCheque = () => {
    // Estados
    ...
    const EXPORT_FIELDS = [
        { key: "trchCodi", label: "ID de cheque" },
        { key: "trpaIdtr", label: "ID de recaudo" },
        { key: "trpaDocu", label: "Documento" },
        { key: "trpaCheq", label: "Valor", format: "currency" },
        { key: "bancEnti", label: "Entidad" },
        { key: "trpaFear", label: "Fecha de consignacion", format: "date" },
    ];
    ...
    const buildURL = (page) => {
        ...
        const url = import.meta.env.VITE_API_BASE_URL_CHEQUE;
